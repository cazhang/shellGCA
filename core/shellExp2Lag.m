function [f, g] = shellExp2Lag(x,FV_ref,FV_vari,Topo,Ev,Ef,Eo,boundaryedges,options)
...
% x1 --> S1, FV_tmp --> S0
[~,g1] = shellGradDeformed(x1,FV_tmp,Topo,Ev,Ef,Eo,boundaryedges,options);
[~,g2] = fastShellGradAndHessUnd(x1,FV_exp,Topo,Ev,Ef,Eo,boundaryedges,options);
...
if nargout > 1
    g = fastMixedHessianShell(FV_vari,FV_exp{1},Topo,Ev,Ef,Eo,boundaryedges,options);
